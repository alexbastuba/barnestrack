...
**O16 · Nose-confidence cutoff.** Default: events use the nose when its heading confidence ≥ 0.6, otherwise the centroid. Closes on: measured nose accuracy on the sample videos.
