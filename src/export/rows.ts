...
export function qualityRows(
  ...
  return analysedVideos(session).map(({ descriptor, analysis }) => {
    ...
    return {
      ...
      positionedFraction: quality.positionedFraction,
      wholeClipPositionedFraction: quality.wholeClipPositionedFraction,
      noseJudgedEventFraction: quality.noseJudgedEventFraction,
